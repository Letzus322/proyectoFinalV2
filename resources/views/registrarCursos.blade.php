  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      <div class="row">
        ...
        <div class="col-xxl-4 col-md-6">
          <div id="toggleButton" class="btn btn-primary btn-sm card info-card revenue-card" data-bs-toggle="collapse" data-bs-target="#contenido">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('cursos.store') }}" class="row g-3">
                      ...
                      <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="malla_curricular" name="malla_curricular" required>
                      </div>
